...
public class Menu {
	...
	public static void displayMenu() throws IOException{ 
		...
		System.out.print("Create File (1) | ");
		System.out.print("Display File (2) | ");
		System.out.print("Retrieve a Record (3) | ");
		System.out.print("Modify a Record (4) | ");
		System.out.print("Add a New Record (5) | ");
		System.out.print("Delete a Record (6) | ");
		System.out.print("Exit (7)");
		System.out.println();
		mainMenu();
	}
	...
	public static void mainMenu() throws IOException{
		...
		switch (Selection){
			...
			case "2": StudentPrinter.printShortList(Main.students, Main.studentList);
					  break;
			case "3": Main.retrieveRecord();
					  break;
			case "4": Main.modifyRecord();
					  break;
			case "5": StudentHandler.newRecord(Main.students, Main.studentList);
					  break;
			case "6": Main.deleteStudent();
					  break;
